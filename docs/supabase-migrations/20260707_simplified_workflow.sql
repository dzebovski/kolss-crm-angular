...
-- Canonical copy: kolss-crm/supabase/migrations/20260707120000_simplified_workflow.sql
-- Apply via `npx supabase db push` from kolss-crm, NOT from kolss-crm-angular.
