...
if (!generatedTypes.includes("API_CONTRACT_VERSION = '2.29.0'")) {
  violations.push('Generated API contract is not pinned to 2.29.0');
}

const manifest = JSON.parse(
  readFileSync(resolve(appRoot, 'core/api/generated/kolss-api.contract.json'), 'utf8'),
);
if (manifest.version !== '2.29.0') violations.push('Generated API manifest is not v2.29.0');
...
console.log('API boundary verified: Supabase browser access is auth-only; contract v2.29.0.');
